...
func ConnectDB() *gorm.DB {
	...
	dsn = fmt.Sprintf("host=%s port=%d user=%s password=%s dbname=%s search_path=%s sslmode=disable TimeZone=UTC", Env.DBHost, port, Env.DBUser, Env.DBPassword, Env.DBName, Env.DBSchema)
